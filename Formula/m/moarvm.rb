class Moarvm < Formula
  ...
  url "https://github.com/MoarVM/MoarVM/releases/download/2024.03/MoarVM-2024.03.tar.gz"
  ...
  resource "nqp" do
    url "https://github.com/Raku/nqp/releases/download/2024.03/nqp-2024.03.tar.gz"
