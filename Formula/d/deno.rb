class Deno < Formula
  ...
  url "https://github.com/denoland/deno/releases/download/v1.43.5/deno_src.tar.gz"
  ...
  resource "v8" do
    url "https://github.com/denoland/v8/archive/refs/tags/12.4.254.13-denoland-c977f60d08cc56299d1c.tar.gz"
